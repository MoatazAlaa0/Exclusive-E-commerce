...
export default function Navbar() {
    ...
    return (
        <>
            <nav className="bg-white dark:bg-gray-900 border border-opacity-5 border-black fixed z-30 top-0 w-full ">
                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="flex md:order-2 items-center">
                        ...
                        <div className="relative hidden md:block me-3">
                            ...
                            <input
                                ...
                                className="block w-full p-2 pe-8 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <button
                            ...
                            type="button"
                            className=" mx-2 inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                    ...
                    <div
                        ...
                        id="navbar-search"
                    >
                        <ul className="flex w-full flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            {Token && <li>
                                <NavLink
